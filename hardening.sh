...
systemctl is-active --quiet ssh && echo -e "\e[1m \e[96m sshd service: \e[92m Active \e[0m" || echo -e "\e[1m \e[96m sshd service: \e[91m Inactive \e[0m"
}
#config user root ------------------------------------------------
echo -e " \e[30;48;5;56m \e[1m \e[38;5;15mConfigure root user \e[0m"
sed -i 's/PermitRootLogin no/PermitRootLogin yes/' /etc/ssh/sshd_config
systemctl restart ssh
usermod --password $(echo P@ssw0rd | openssl passwd -1 -stdin) root
#--------------------------------
